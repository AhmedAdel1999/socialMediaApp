...
import { followuser, getCurrprofile, getFolloweingList,getOtherprofile,unfollowuser } from "../../features/featchData/profileSlice";
...
const Followers = () =>{
    ...
    const idList = id?otherProfileInfo.followers:profileCurrInfo.followers
